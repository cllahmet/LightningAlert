...
namespace LightningAlert.Helpers
{
    static class TileSystem
    {
        ...
        private const int DefaultLevelOfDetail = 12;
        ...
        public static string LatLongToQuadKey(double latitude, double longitude, int levelOfDetail = DefaultLevelOfDetail)
        {
